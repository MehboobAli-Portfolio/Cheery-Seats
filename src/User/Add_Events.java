...
public class Add_Events extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd"); // MySQL compatible date format
        ...
        String ticketCountStr = jTextField2.getText().trim(); // New field for ticket count
        ...
        Event event = EventFactory.createEvent(eventType, eventName, eventDate, eventDescription, id, ticketCount);
        event.saveEvent();
